...
#pragma message "Timer1 prescaler is not supported in DA14682/3 chips."
...
#error "Both dg_configPOWER_EXT_1V8_PERIPHERALS and dg_configPOWER_1V8P are defined! Please use dg_configPOWER_1V8P only!"
        ...
        #pragma message "dg_configPOWER_EXT_1V8_PERIPHERALS will be deprecated! Use dg_configPOWER_1V8P instead!"
...
#pragma message "dg_configPOWER_FLASH is deprecated! Use dg_configPOWER_1V8_ACTIVE instead!"
#endif
...
/**
 * \brief Enable stack and heap protection.
 *
 * \note Heap and stack memory areas can be periodically checked for overflow. Meaningful for FreeRTOS projects.
 *
 * \bsp_default_note{\bsp_config_option_app,}
 */
#ifndef dg_configCHECK_HEAP_STACK_OVERRUN
#define dg_configCHECK_HEAP_STACK_OVERRUN        (0)
#endif
