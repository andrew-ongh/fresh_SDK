...
static void periph_init(void)
{
        ...
        hw_gpio_configure_pin(CFG_TRIGGER_CONNECT_GPIO_PORT, CFG_TRIGGER_CONNECT_GPIO_PIN,
...
{
        hw_wkup_init(NULL);
        hw_wkup_configure_pin(CFG_TRIGGER_CONNECT_GPIO_PORT, CFG_TRIGGER_CONNECT_GPIO_PIN, 1,
