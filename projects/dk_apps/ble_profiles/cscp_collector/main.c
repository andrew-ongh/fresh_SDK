 ...
 * @file main.c
 *
 * @brief Cycling Speed and Cadence demo application
 *
...
/* Task priorities */
#define mainCSCP_COLLECTOR_TASK_PRIORITY              ( OS_TASK_PRIORITY_NORMAL )
...
static void system_init( void *pvParameters )
{
        ...
        /* Start the CSCP Collector application task. */
        OS_TASK_CREATE("CSCP Collector",                        /* The text name assigned to the task, for
                                                                   debug only; not used by the kernel. */
                       cscp_collector_task,                     /* The function that implements the task. */
                       NULL,                                    /* The parameter passed to the task. */
                       1024,                                    /* The number of bytes to allocate to the
                                                                   stack of the task. */
                       mainCSCP_COLLECTOR_TASK_PRIORITY,        /* The priority assigned to the task. */
...
#endif
        hw_wkup_register_interrupt(wkup_interrupt_cb, 1);
}
