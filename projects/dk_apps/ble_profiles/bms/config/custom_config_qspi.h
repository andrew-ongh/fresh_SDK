...
#define configTOTAL_HEAP_SIZE                    18384   /* This is the FreeRTOS Total Heap Size */
...
#define defaultBLE_PPCP_INTERVAL_MIN            (BLE_CONN_INTERVAL_FROM_MS(150))    // 150 ms
#define defaultBLE_PPCP_INTERVAL_MAX            (BLE_CONN_INTERVAL_FROM_MS(200))    // 200 ms
