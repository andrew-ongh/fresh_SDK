...
static void system_init( void *pvParameters )
{
        ...
        OS_TASK_CREATE("HRP Sensor",                    /* The text name assigned to the task, for
                                                           debug only; not used by the kernel. */
                       hrp_sensor_task,                 /* The function that implements the task. */
...
static void periph_init(void)
{
        ...
        hw_gpio_configure_pin(CFG_START_ADVERTISING_TRIGGER_GPIO_PORT,
                                CFG_START_ADVERTISING_TRIGGER_GPIO_PIN, HW_GPIO_MODE_INPUT_PULLUP,
                                                                          HW_GPIO_FUNC_GPIO, true);
}
...
static void prvSetupHardware( void )
{
        ...
        hw_wkup_init(NULL);
        hw_wkup_configure_pin(CFG_START_ADVERTISING_TRIGGER_GPIO_PORT,
                                CFG_START_ADVERTISING_TRIGGER_GPIO_PIN, true, HW_WKUP_PIN_STATE_HIGH);
#if dg_configBLACK_ORCA_IC_REV == BLACK_ORCA_IC_REV_A
