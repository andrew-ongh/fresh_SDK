 ...
 * @file main.c
 *
 * @brief Heart Rate Profile Collector role application
 *
...
/* Task priorities */
#define mainHRP_COLLECTOR_TASK_PRIORITY              ( OS_TASK_PRIORITY_NORMAL )
...
static void system_init( void *pvParameters )
{
        ...
        /* Start the HRP Collector application task. */
        OS_TASK_CREATE("HRP Collector",                         /* The text name assigned to the task, for
                                                                   debug only; not used by the kernel. */
                       hrp_collector_task,                      /* The function that implements the task. */
                       NULL,                                    /* The parameter passed to the task. */
                       1024,                                    /* The number of bytes to allocate to the
                                                                   stack of the task. */
                       mainHRP_COLLECTOR_TASK_PRIORITY,         /* The priority assigned to the task. */
