...
/* Task priorities */
#define mainBLE_SUOTA_CLIENT_TASK_PRIORITY              ( OS_TASK_PRIORITY_NORMAL )
...
void ble_suota_client_task( void *pvParameters);
...
static void system_init( void *pvParameters )
{
        ...
        OS_TASK_CREATE("SUOTA",                         /* The text name assigned to the task, for
                       ...
                       ble_suota_client_task,           /* The function that implements the task. */
                       NULL,                            /* The parameter passed to the task. */
                       1536,                            /* The number of bytes to allocate to the
                                                           stack of the task. */
                       mainBLE_SUOTA_CLIENT_TASK_PRIORITY,/* The priority assigned to the task. */
