 ...
 */
#define dg_configQSPI_CACHED_RAM_SIZE_AE           ( 62 * 1024)
#define dg_configQSPI_CACHED_RETRAM_0_SIZE_AE      ( 66 * 1024)
#define dg_configQSPI_CACHED_RAM_SIZE_BB           ( 61 * 1024)
#define dg_configQSPI_CACHED_RETRAM_0_SIZE_BB      ( 67 * 1024)
