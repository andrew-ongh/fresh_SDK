...
##################################   +
msg1 = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_HOPPING_SEQUENCE_LIST, 'PIBAttributeValue': [1,6,8,4,5,2,3,7,10] }
...
# Set Hopping lenght
##################################   +
msg1 = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_HOPPING_SEQUENCE_LENGTH, 'PIBAttributeValue': 9 }
...
links = [ { 'linkHandle': 0, 'linkOptions': 10, 'linkType': 0, 'slotframeHandle': 1, 'nodeAddress': 0, 'timeslot': 0, 'channelOffset': 0 },
          ...
          { 'linkHandle': 4, 'linkOptions': 15, 'linkType': 0, 'slotframeHandle': 1, 'nodeAddress': 1, 'timeslot': 6, 'channelOffset': 0 },
...
msg1 = {'msgId': ftdf.FTDF_DATA_REQUEST,
...
msg2 = {'msgId': ftdf.FTDF_DATA_REQUEST,
       'srcAddrMode': ftdf.FTDF_SHORT_ADDRESS,
       'dstAddrMode': ftdf.FTDF_SHORT_ADDRESS,
       'dstPANId': 0x1234,
       'dstAddr': 0x0001,
...
for x in range(0, 25920000): # 3 dagen test
    ...
    if (res2 == False):
        ...
        print( 'SCRIPT: message send oke side 1!' )
    ...
    if (res2 == False):
        ...
        print( 'SCRIPT: message send oke side 2!' )
