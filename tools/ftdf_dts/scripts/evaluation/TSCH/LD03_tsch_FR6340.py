...
# This script can be run as is to test:
# Test transmit precedence over reception

# Test the channel number used to send the frame will indicate that the lowest slot number was chosen:
# Test link of lowest slot number has precedence when the two links are both receive links
# Test link of lowest slot number has precedence when the two links are both transmit links
...
# Hopping sequence
hoppingSequence = [10,15,10,15,10,15,10,15,10,15,10,15,10,15,10,15]
msgSET_HoppingSequence = {
  'msgId': ftdf.FTDF_SET_REQUEST,
  'PIBAttribute': ftdf.FTDF_PIB_HOPPING_SEQUENCE_LIST,
  'PIBAttributeValue': hoppingSequence
}
msgSET_HoppingSequenceLength = {
  'msgId': ftdf.FTDF_SET_REQUEST,
  'PIBAttribute': ftdf.FTDF_PIB_HOPPING_SEQUENCE_LENGTH,
  'PIBAttributeValue': len(hoppingSequence)
}
...
msgFlow = (
  ...
  devId1, msg_Slotframe_Add_1, ftdf.FTDF_SET_SLOTFRAME_CONFIRM,
  devId2, msg_Slotframe_Add_1, ftdf.FTDF_SET_SLOTFRAME_CONFIRM,

  devId1, msg_Link_Add_0_0, ftdf.FTDF_SET_LINK_CONFIRM,
  devId2, msg_Link_Add_0_0, ftdf.FTDF_SET_LINK_CONFIRM,
  devId1, msg_Link_Add_1_1, ftdf.FTDF_SET_LINK_CONFIRM,
  devId2, msg_Link_Add_1_1, ftdf.FTDF_SET_LINK_CONFIRM,

  devId1, msgSET_HoppingSequence, ftdf.FTDF_SET_CONFIRM,
  devId1, msgSET_HoppingSequenceLength, ftdf.FTDF_SET_CONFIRM,
  devId2, msgSET_HoppingSequence, ftdf.FTDF_SET_CONFIRM,
  devId2, msgSET_HoppingSequenceLength, ftdf.FTDF_SET_CONFIRM,
  ...
  # Test link of lowest slot number has precedence when the two links are both receive links
  devId1, msg_Link_Delete_0_0, ftdf.FTDF_SET_LINK_CONFIRM,
  devId1, msg_Link_Delete_1_1, ftdf.FTDF_SET_LINK_CONFIRM,
  devId2, msg_Link_Delete_0_0, ftdf.FTDF_SET_LINK_CONFIRM,
  devId2, msg_Link_Delete_1_1, ftdf.FTDF_SET_LINK_CONFIRM,
  devId1, msg_Link_Add_0_0_Transmit, ftdf.FTDF_SET_LINK_CONFIRM,
  devId2, msg_Link_Add_0_0_Receive, ftdf.FTDF_SET_LINK_CONFIRM,
  devId2, msg_Link_Add_1_1_Receive, ftdf.FTDF_SET_LINK_CONFIRM,
  devId1, msgDATA, ftdf.FTDF_DATA_CONFIRM,
  ...
  devId2, msg_Link_Delete_1_1, ftdf.FTDF_SET_LINK_CONFIRM,
  devId1, msg_Link_Add_0_0_Transmit, ftdf.FTDF_SET_LINK_CONFIRM,
  devId1, msg_Link_Add_1_1_Transmit, ftdf.FTDF_SET_LINK_CONFIRM,
  devId2, msg_Link_Add_0_0_Receive, ftdf.FTDF_SET_LINK_CONFIRM,
  devId1, msgDATA, ftdf.FTDF_DATA_CONFIRM,
)
  ...
  if( res == False ):
    ...
    if( ret['msgId'] == ftdf.FTDF_BEACON_CONFIRM ):
      ...
      if( ret['status'] != ftdf.FTDF_SUCCESS ):
        logstr = ( 'SCRIPT: devId:', msgFlow[idx], ' request:', msgNameStr[ msgFlow[idx+1]['msgId'] -1 ], 'attribute:', pibAttributeStr[ msgFlow[idx+1]['PIBAttribute'] -1 ], ' result:', resultStr[ ret['status'] ] )
        raise StopScript( ''.join( map( str, logstr ) ) )
        result = False
        break
