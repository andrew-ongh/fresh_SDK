...
# This script was used to manually check that the PHY will stay disabled 
# when no frame in transmission que matches link specification.
# This was done for transmit or shared linkoption
...
msg_Link_Add_Dev1_0 = {
    ...
    'timeslot': 0,
    'channelOffset': 0,
    'linkOptions': linkOptions_Shared | linkOptions_Transmit,
    'linkType': 0,
    'nodeAddress': 0x0020,
}
msg_Link_Add_Dev2_0 = {
...
while( idx < len( msgFlow ) ):
    ...
    if( msgFlow[idx+2] == ftdf.FTDF_DATA_CONFIRM ):
        # no need to wait on dataframe that should stay in que forever
        idx += 3
        continue
