...
dataFrame_Incorrect_Panid = [
    frameControlByte0,
    frameControlByte1, # Frame Control
    0x05, # Sequence number
    0x02, # Destination PanId
    0x00,
    0x20, # Destination address
    0x00,
    0x01, # Source PanId
...
commandFrame_Incorrect_Address = [
    frameControlByte0,
    frameControlByte1, # Frame Control
...
#------------------------------- Beacon Frame (Incorrect: source PANid):
# Frame Control:
frameControl_FrameType          = 0x0000 # Beacon
#frameControl_FrameType         = 0x0001 # DataFrame
#frameControl_FrameType         = 0x0002 # Acknowledgment
...
options = ( ftdf.FTDF_TRANSPARENT_PASS_ALL_ADDR |
            ftdf.FTDF_TRANSPARENT_PASS_ALL_PAN_ID |
            ftdf.FTDF_TRANSPARENT_PASS_ALL_BEACON # Option to pass specific PANid mismatch in beacons
            )
enable = True
DTS_enableTransparantMode( devId2, enable, options )

# Message order
msgFlow = ( dataFrame_Incorrect_Address, ftdf.FTDF_DATA_INDICATION,
            dataFrame_Incorrect_Panid, ftdf.FTDF_DATA_INDICATION,
            commandFrame_Incorrect_Address, ftdf.FTDF_ORPHAN_INDICATION,
            commandFrame_Incorrect_Panid, ftdf.FTDF_ORPHAN_INDICATION,
            beaconFrame_Incorrect_Panid, ftdf.FTDF_BEACON_NOTIFY_INDICATION )
