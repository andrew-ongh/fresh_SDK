    ...
    if( res == False ):
        ...
        if( ret['msgId'] == ftdf.FTDF_DATA_CONFIRM ):
            ...
            if( res == False ):
                ...
                if( msgFlow[idx+3] == 1 ):
                    expectedFrame = [105, 152, 119, 1, 0, 32, 0, 16, 0, 29, 241, 255, 255, 255, 8, 9, 10, 11, 12, 13, 14, 15, 5, 116, 98, 238, 59, 74, 229, 112, 179, 120, 235, 28]
                elif( msgFlow[idx+3] == 2 ):
                    expectedFrame = [105, 152, 120, 1, 0, 32, 0, 16, 0, 93, 241, 255, 255, 255, 255, 8, 9, 10, 11, 12, 13, 14, 15, 5, 98, 173, 204, 251, 78, 61, 91, 228, 204, 195, 98]
