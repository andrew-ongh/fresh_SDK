...
##################################
hoppingSeq = [6,8,4,5,2,3,7,10]
msg1 = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_HOPPING_SEQUENCE_LIST, 'PIBAttributeValue': hoppingSeq }
...
# Set Hopping lenght
##################################   +
msg1 = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_HOPPING_SEQUENCE_LENGTH, 'PIBAttributeValue': len(hoppingSeq) }
...
data1 = {'msgId': ftdf.FTDF_DATA_REQUEST,
...
data2 = {'msgId': ftdf.FTDF_DATA_REQUEST,
       'srcAddrMode': ftdf.FTDF_SHORT_ADDRESS,
       'dstAddrMode': ftdf.FTDF_SHORT_ADDRESS,
       'dstPANId': 0x1234,
       'dstAddr': 0x0001,
...
# Send data request to dev 1
DTS_sndMsg( devId1, data1 )
...
# Send data request to dev 2
DTS_sndMsg( devId2, data2 )
...
res2, ret2 = DTS_getMsg( devId1, responseTimeout )
