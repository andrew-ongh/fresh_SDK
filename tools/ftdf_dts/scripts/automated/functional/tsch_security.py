...
##################################
msg1 = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_EXTENDED_ADDRESS, 'PIBAttributeValue': 0x0001000100010001 }
msg2 = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_EXTENDED_ADDRESS, 'PIBAttributeValue': 0x0002000200020002 }
...
##################################
# SecurityLevelTable
val = {'nrOfSecurityLevelDescriptors': 3,
       'securityLevelDescriptors': [{'frameType': 0,
                                     'commandFrameId': 0,
                                     'securityMinimum': 5,
...
msg = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_SECURITY_LEVEL_TABLE, 'PIBAttributeValue': val }
...
val = {'nrOfDeviceDescriptors': 1,
        'deviceDescriptors': [{'PANId': PANId,
                               'shortAddress': 0x0002,
                               'extAddress': 0x0002000200020002,
                               'frameCounter': 0,
                               'exempt': 0 }]}

msg = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_DEVICE_TABLE, 'PIBAttributeValue': val }
...
val = {'nrOfKeyDescriptors': 1,
       'keyDescriptors': [{'nrOfKeyIdLookupDescriptors': 1,
                           'keyIdLookupDescriptors': [{'keyIdMode': 1,
                                                       'keySource': keySource,
                                                       'keyIndex': 5,
                                                       'deviceAddrMode': 0,
                                                       'devicePANId': 0,
                                                       'deviceAddress': 0 }],
                           'nrOfDeviceDescriptorHandles': 2,
                           'deviceDescriptorHandles': [0, 1],
                           'nrOfKeyUsageDescriptors': 3,
                           'keyUsageDescriptors': [{'frameType': 0,
                                                    'commandFrameId': 0},
                                                   {'frameType': 1,
                                                    'commandFrameId': 0},
                                                   {'frameType': 2,
                                                    'commandFrameId': 0}],
                           'key': [ 0x7e, 0x37, 0x2d, 0x41, 0xdf, 0x74, 0x72, 0x3f,
                                    0x4c, 0x3a, 0xa7, 0x53, 0xa1, 0x11, 0x46, 0x8b]}]}

msg = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_KEY_TABLE, 'PIBAttributeValue': val }
...
# Set deafult key source
msg = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_DEFAULT_KEY_SOURCE, 'PIBAttributeValue': [0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f]}
...
# Enable security
##################################
msg = { 'msgId': ftdf.FTDF_SET_REQUEST, 'PIBAttribute': ftdf.FTDF_PIB_SECURITY_ENABLED, 'PIBAttributeValue': 1 }
...
if (res1 == False):
    dtsLog.error( "No response received from device!" )
    result = False
elif (ret1['msgId'] != ftdf.FTDF_DATA_CONFIRM):
    dtsLog.error( "Incorrect response received from device: ret1=%s" % (ret1['msgId']))
    result = False
...
if (res2 == False):
    ...
    dtsLog.error( "Incorrect response received from device: ret2=%s" % (ret2['msgId']))
    result = False
